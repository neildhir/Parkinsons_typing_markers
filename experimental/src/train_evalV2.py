...
def run_experiment(data_path,fold_path,prefix,participant_norm,global_norm,sentence_norm = False):
    ...
    for test_fold in df.fold.unique():
        ...
        train_mask = fold_wordpair != test_fold
        ...
        history = wordpair_model.fit(x_train, y_train, validation_data = (x_val,y_val), epochs=200, verbose=1, batch_size=64, shuffle=True,
        ...
        history = sentence_model.fit(x_train, y_train, callbacks=callbacks, validation_split=0.2, epochs=200, verbose=1,
