...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--num_folds", metavar="", type=int, required=True, help="path to data")
    parser.add_argument("-o", "--output_name", metavar="", type=str, required=True, help="name of output file")
    args = parser.parse_args()

    main(data_path=args.data_path, num_folds=args.num_folds, output_name=args.output_name)
